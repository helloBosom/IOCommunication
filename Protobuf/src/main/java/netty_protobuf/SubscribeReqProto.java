...
public final class SubscribeReqProto {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return netty_protobuf.SubscribeReqProto.internal_static_netty_SubscribeReq_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return netty_protobuf.SubscribeReqProto.internal_static_netty_SubscribeReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              netty_protobuf.SubscribeReqProto.SubscribeReq.class, netty_protobuf.SubscribeReqProto.SubscribeReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof netty_protobuf.SubscribeReqProto.SubscribeReq)) {
        return super.equals(obj);
      }
      netty_protobuf.SubscribeReqProto.SubscribeReq other = (netty_protobuf.SubscribeReqProto.SubscribeReq) obj;
    ...
    public static netty_protobuf.SubscribeReqProto.SubscribeReq parseFrom(
    ...
    public static netty_protobuf.SubscribeReqProto.SubscribeReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static netty_protobuf.SubscribeReqProto.SubscribeReq parseFrom(
    ...
    public static netty_protobuf.SubscribeReqProto.SubscribeReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static netty_protobuf.SubscribeReqProto.SubscribeReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static netty_protobuf.SubscribeReqProto.SubscribeReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(netty_protobuf.SubscribeReqProto.SubscribeReq prototype) {
    ...
    public static final class Builder extends
        ...
        netty_protobuf.SubscribeReqProto.SubscribeReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return netty_protobuf.SubscribeReqProto.internal_static_netty_SubscribeReq_descriptor;
      }
      ...
      // Construct using netty_protobuf.SubscribeReqProto.SubscribeReq.newBuilder()
      private Builder() {
      ...
      public netty_protobuf.SubscribeReqProto.SubscribeReq getDefaultInstanceForType() {
        return netty_protobuf.SubscribeReqProto.SubscribeReq.getDefaultInstance();
      }

      public netty_protobuf.SubscribeReqProto.SubscribeReq build() {
        netty_protobuf.SubscribeReqProto.SubscribeReq result = buildPartial();
      ...
      public netty_protobuf.SubscribeReqProto.SubscribeReq buildPartial() {
        netty_protobuf.SubscribeReqProto.SubscribeReq result = new netty_protobuf.SubscribeReqProto.SubscribeReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof netty_protobuf.SubscribeReqProto.SubscribeReq) {
          return mergeFrom((netty_protobuf.SubscribeReqProto.SubscribeReq)other);
        } else {
      ...
      public Builder mergeFrom(netty_protobuf.SubscribeReqProto.SubscribeReq other) {
        if (other == netty_protobuf.SubscribeReqProto.SubscribeReq.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        netty_protobuf.SubscribeReqProto.SubscribeReq parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (netty_protobuf.SubscribeReqProto.SubscribeReq) e.getUnfinishedMessage();
  ...
  ensureAddressIsMutable();
    ...
    private static final netty_protobuf.SubscribeReqProto.SubscribeReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new netty_protobuf.SubscribeReqProto.SubscribeReq();
    }

    public static netty_protobuf.SubscribeReqProto.SubscribeReq getDefaultInstance() {
